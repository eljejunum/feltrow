...
<?php get_template_part( 'menu', 'index' ); //the  menu + logo/site title ?>
	...
	<section id="maincontent" class="sidebar-<?php echo of_get_option('portf-sidebar-position') ?>">
		<div class="container">		
			<div class="mainside columns single-portf">
						...
						<article id="post-<?php the_ID(); ?>" class="clearfix">
							<div class="date-data">
								...
								<ul class="post-data">
									...
									<li><?php _e('Category:', 'glenon_wp') ?> <?php echo get_the_term_list( $post->ID, 'portfolio_cat', '', ', ', '' ); ?></li>
							...
							<?php if ( ! is_attachment() ) : ?>
								<?php if ( has_post_thumbnail() ) { 
									...
									<a href="<?php echo $full_image_url[0] ?>" class="thumb-link">
										<?php 
											if ( of_get_option('portf-sidebar-position') == 'none' ) {
