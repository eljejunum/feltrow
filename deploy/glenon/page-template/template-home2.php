		...
		<div class="container">
			<div class="sixteen columns">
				<div class="gutter alpha omega">
					<section id="primary" class="portf four-columns home2">
						<?php portf_layout(); ?>
					</section><!-- #primary -->
...
<?php get_template_part('includes/latest-blog'); ?>
			
	<section id="maincontent" class="sidebar-<?php echo of_get_option('home-sidebar-position') ?> forhome">	
		<div class="container">	
