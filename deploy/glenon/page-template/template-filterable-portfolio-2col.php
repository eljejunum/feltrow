<?php 
/* 
 * Template Name: Filterable Portfolio 2 Column  
 * Description: A full-width template with no sidebar for Portfolio 2 Columns
 *
 * @package WordPress
		...
		<div class="container">
			...
			<div class="sixteen columns">
				<div class="gutter alpha omega">
					<section id="primary" class="portf two-columns">
						<div id="content">
